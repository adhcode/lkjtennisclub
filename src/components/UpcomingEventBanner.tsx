                ...
                <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                            <div>
                                <h3 className={`text-[#911b1e] text-sm sm:text-base font-medium leading-tight ${brunoAce.className}`}>
                                    ALIMOSHO SUMMER TENNIS CLINIC
                                </h3>
                                <div className={`flex items-center gap-3 text-xs text-[#911b1e]/70 ${raleway.className}`}>
                                    <span>Aug 4-23, 2025</span>
                                    <span>•</span>
                                    <span>Ages 4-17</span>
                                    <span>•</span>
                                    <span>9AM Daily</span>
                    ...
                    {/* CTA Button */}
                    <Link
                        href="/events/summer-camp-registration"
